...
@section('title', 'Admitted Marketing List - European IT Solutions Institute')
            ...
            <div class="col-md-10 col-lg-12">
                <div class="card">
                    <div class="card-header text-center">
                        <span class="float-left"><h4>Admitted Marketing Search List</h4></span>
                        <span>
                        ...
                        <span class="float-right">
                            <a href="{{route('marketing.admitted.list')}}" class="btn btn-sm btn-info">Back</a>
                        </span>
                    </div>
                    <div class="card-body">
                        @if(session('success'))
